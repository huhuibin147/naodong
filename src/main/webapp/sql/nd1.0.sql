...
CREATE TABLE `answer` (
  ...
  `qid` int(50) DEFAULT NULL COMMENT '问题ID',
  `uid` int(50) DEFAULT NULL COMMENT '回答用户ID',
...
CREATE TABLE `guanzhu` (
  `id` int(50) NOT NULL,
  `uid` int(50) DEFAULT NULL COMMENT '用户id',
  `uuid` int(50) DEFAULT NULL COMMENT '关注的用户id',
  `aid` int(50) DEFAULT NULL COMMENT '收藏的回答id',
  `qid` int(50) DEFAULT NULL COMMENT '关注的问题id',
  `tid` int(50) DEFAULT NULL COMMENT '主题id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `question` (
  ...
  `uid` int(50) DEFAULT NULL COMMENT '问题的提出用户ID',
  `time` datetime DEFAULT NULL COMMENT '提出时间',
  `aid` int(50) DEFAULT NULL COMMENT '回答编号ID',
  `anonymity` int(11) DEFAULT NULL COMMENT '匿名',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'bin', '123', 'hb', '405622418@qq.com', null, '男', '。。', '1', null);
INSERT INTO `user` VALUES ('2', 'hb', '123', 'hb', '1677323371@qq.com', null, '女', '。。', '0', null);
INSERT INTO `user` VALUES ('3', 'bin2', '1', 'b', '1', null, null, null, null, null);
